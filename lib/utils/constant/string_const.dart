class StringConst {
  static const String appName = 'Tournament';
  ...
  static var areYouSureExit = 'Are you sure you want to exit this app?';
  static var yes = 'Yes';
  static var no = 'No';
  ...
  static var latestUpdate = 'Latest Update';

  static var largeHeight = 'largeHeight';
  static var smallHeight = 'smallHeight';
  static var largeHeightWidth = 'largeHeightWidth';
  static var squre = 'squre';
  static var RUPEE_SYMBOL = '\u20B9';

  static var myWallet = "My Wallet";

  static var complaint = 'Complaint';
  ...
  static var invalidUserPwd = 'Invalid username and password';

  static var flyingWolf = 'FlyingWolf';
  static var deepakSharma = 'Deepak Sharma';
  static var recommended_for_you = "Recommended for you";
  static String tournaments_played = 'Tournaments\nplayed';
