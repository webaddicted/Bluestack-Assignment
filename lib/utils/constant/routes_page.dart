...
import 'package:tournament/view/algo_page.dart';
import 'package:tournament/view/home/detail_page.dart';
...
List<GetPage> routesPage() => [
      ...
      // GetPage(name: RoutersConst.initialRoute, page: () => const AlgoPage()),
      GetPage(name: RoutersConst.loginPage, page: () => const LoginPage()),
      GetPage(name: RoutersConst.home, page: () => HomePage()),
      GetPage(name: RoutersConst.detail+"/:data", page: () => DetailPage()),
    ];
